...
def p_r_f1(preds: List[Union[int, str]], golds: List[Union[int, str]], prefix=None, pos_label=0) -> dict:
    """
    ...
    Args:
        ...
        prefix (str, optional):
            Metric name prefix of results.
        pos_label (optional, defaults to 0):
            The positive label, defaults to 0.
